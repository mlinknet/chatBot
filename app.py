...
faq_data = {
    ...
    "駐車場割引はありますか？": "割引価格で「駐車回数券」を、地下1階のミニコンビニ「センターショップ」で販売しております。1枚から購入可能です。営業時間は「8:30～15:30」です。",
    "駐車券の販売場所を教えてください。": "割引価格で「駐車回数券」を、地下1階のミニコンビニ「センターショップ」で販売しております。1枚から購入可能です。営業時間は「8:30～15:30」です。",

    # 【駐車場】営業時間
    "駐車場の営業時間は何時から何時までですか？": "営業時間は7:00から23:00まで。入庫は22:00までです。23:00～翌朝7:00は出庫できません。宿泊料金として留め置き料金1,000円（23:00～翌朝8:00まで）が加算されます。",
    "駐車場は何時から何時まで営業していますか？": "営業時間は7:00から23:00まで。入庫は22:00までです。23:00～翌朝7:00は出庫できません。宿泊料金として留め置き料金1,000円が加算されます。",

    # 【飲食店】飲食店はありますか？
    "飲食店はありますか？": "地下1階が飲食店フロアで、12階にも食堂があります。詳しくは（https://www.kobe-citc.com/restaurant/#restaurant）をご覧ください。地下1階の中華料理店以外は平日昼間のみの営業です。",
    "館内で食事できる場所はありますか？": "地下1階が飲食店フロアで、12階にも食堂があります。詳しくは（https://www.kobe-citc.com/restaurant/#restaurant）をご覧ください。地下1階の中華料理店以外は平日昼間のみの営業です。",
    "レストランはありますか？": "地下1階が飲食店フロアで、12階にも食堂があります。詳しくは（https://www.kobe-citc.com/restaurant/#restaurant）をご覧ください。地下1階の中華料理店以外は平日昼間のみの営業です。",
}
